...
function testCompiler ()
  lu.assertEquals( compile(parse("1 % 2")),      {"push", 1, "push", 2, "mod"})
  lu.assertEquals( compile(parse("3 ^ 4")),      {"push", 3, "push", 4, "pow"})
  lu.assertEquals( compile(parse("1 % 2 ^ 10")), {"push", 1, "push", 2, "push", 10, "pow", "mod"})
end
...
function testInterpreter ()
  lu.assertEquals( run(compile(parse("1 + 2*10 + 3*10^2"))), 321)
end
